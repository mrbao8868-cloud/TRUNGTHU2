...
const GeneratedImage: React.FC<GeneratedImageProps> = ({ imageUrl }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-8 flex flex-col items-center">
        <h2 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400 mb-6">Tác phẩm của bạn!</h2>
        <div className="relative group p-1.5 bg-gradient-to-br from-yellow-400 via-orange-500 to-yellow-600 rounded-xl shadow-2xl shadow-yellow-500/20">
